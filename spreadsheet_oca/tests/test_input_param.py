...
"""
Tests for Feature 4 — Named Input Parameters.
...
class TestCellRefHelpers(TransactionCase):
    ...
    def test_write_cell_content(self):
        ...
        cell = result["sheets"][0]["cells"]["2"]["1"]
...
class TestInputParam(TransactionCase):
    ...
    def test_sync_missing_cell_no_error(self):
        ...
        self.spreadsheet.write({"spreadsheet_raw": {"sheets": [{"id": "s1", "name": "Sheet1", "cells": {}}]}})
    ...
    def test_smart_button_count(self):
        ...
        p1 = self._make_param(name="cnt_a")
    ...
    def test_refresh_uses_params(self):
        ...
        raw = {
            "version": 1,
            "sheets": [{"id": "s1", "name": "Sheet1", "cells": {"2": {"1": {"content": "Administrator"}}}}],
            "pivots": {
                "1": {
                    "type": "ODOO",
                    "model": "res.partner",
