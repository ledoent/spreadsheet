...
"""
Phase 1 spike tests — Python pivot data computation.
...
from ..models.pivot_data import _get_pivot_data, _sections, _dimension_to_groupby
...
class TestPivotDataHelpers(TransactionCase):
    ...
    def test_dimension_no_granularity(self):
        self.assertEqual(_dimension_to_groupby({"fieldName": "partner_id"}), "partner_id")
...
class TestPivotData(TransactionCase):
    ...
    def test_row_and_col_groupby(self):
        ...
        # Divisors: ([], []) ([], [is_company]) ([country_id], []) ([country_id], [is_company])
